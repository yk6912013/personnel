  ...
  <div>
      ...
      <el-scrollbar style="height: 100%;">
        <div>
          <el-table :data="mainnotices"
            ...
            <el-table-column align="center" prop="authon"
                             label="发布人"
                             width="150">
            </el-table-column>
            <el-table-column align="center" prop="updateTime"
                             label="更新时间"
                             width="200">
            </el-table-column>
    ...
    <el-drawer :before-close="handleClose"
      ...
      <div class="center-right-infinite-list">
        <el-scrollbar style="height: 100%;width:100%">
          ...
          <header style="margin-left: 40%;font-size: 24px; font-weight:bold;">{{ mainnotice.title }}</header>
          <el-divider/>
    ...
    <el-drawer :before-close="handleClose"
      ...
      <div class="center-right-infinite-list">
        <el-scrollbar style="height: 100%;width:100%">
          <!-- <div v-html="mainnotice.mainbody">  -->
          <header style="margin-left: 45%;font-size: 24px; font-weight:bold;">{{ mainnotice.title }}</header>
          <el-divider/>
          <quill-editor v-model="mainnotice.mainbody"
                        :options="editorOption">
          </quill-editor>
