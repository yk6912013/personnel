                ...
                <el-col :span="6">
                  <el-form-item label="调动后部门:"
                    ...
                    <el-popover placement="right"
                      ...
                      <div slot="reference"
                           style="width: 150px;display: inline-flex;font-size: 14px;padding-left: 15px;border: 1px solid #dedede;height: 38px;border-radius: 5px;cursor: pointer;align-items: center;box-sizing: border-box;"
            ...
            <el-table-column type="expand">
              <template slot-scope="props">
                <el-descriptions
                  ...
                  <el-descriptions-item label="姓名" :span="2">{{props.row.name}}</el-descriptions-item>
                  <el-descriptions-item label="性别">{{props.row.gender}}</el-descriptions-item>
                  <el-descriptions-item label="出生日期">{{props.row.birthday}}</el-descriptions-item>
                  <el-descriptions-item label="身份证号码">{{props.row.idcard}}</el-descriptions-item>
                  <el-descriptions-item label="电子邮件">{{props.row.email}}</el-descriptions-item>
                  <el-descriptions-item label="电话号码">{{props.row.phone}}</el-descriptions-item>
                  <el-descriptions-item label="最高学历">{{props.row.tiptopdegree}}</el-descriptions-item>
                  <el-descriptions-item label="专业">{{props.row.specialty}}</el-descriptions-item>
                  <el-descriptions-item label="毕业院校">{{props.row.school}}</el-descriptions-item>
                </el-descriptions>
              </template>
            </el-table-column>
