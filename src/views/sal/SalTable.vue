            ...
            <el-table-column type="expand">
              <template slot-scope="props">
                <el-descriptions
                  ...
                  border
                  size="medium"
                  style="width: 50%;margin-left: 60px;margin-bottom: 20px; margin-top: 20px">
                  <el-descriptions-item label="所属账套名称" :span="2">{{props.row.salary.name}}</el-descriptions-item>
                  <el-descriptions-item label="启用时间" :span="2">{{props.row.salary.createdate}}</el-descriptions-item>
                  <el-descriptions-item label="基本工资">{{props.row.salary.basicsalary}}</el-descriptions-item>
                  <el-descriptions-item label="交通补助">{{props.row.salary.trafficsalary}}</el-descriptions-item>
                  <el-descriptions-item label="午餐补助">{{props.row.salary.lunchsalary}}</el-descriptions-item>
                  <el-descriptions-item label="奖金">{{props.row.salary.bonus}}</el-descriptions-item>
                  <el-descriptions-item label="养老金基数">{{props.row.salary.pensionbase}}</el-descriptions-item>
                  <el-descriptions-item label="养老金比率">{{props.row.salary.pensionper}}</el-descriptions-item>
                  <el-descriptions-item label="医疗保险基数">{{props.row.salary.medicalbase}}</el-descriptions-item>
                  <el-descriptions-item label="医疗保险比率">{{props.row.salary.medicalper}}</el-descriptions-item>
                  <el-descriptions-item label="公积金基数">{{props.row.salary.accumulationfundbase}}</el-descriptions-item>
                  <el-descriptions-item label="公积金比率">{{props.row.salary.accumulationfundper}}</el-descriptions-item>
                </el-descriptions>
              </template>
            </el-table-column>
