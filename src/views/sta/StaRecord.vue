      ...
      <div style="width:100%;color:#E6A23C">
        <el-carousel indicator-position="outside"
          ...
          <el-carousel-item v-for="(item,index) in datas"
                            :key="index"
                            style="border-radius: 10px;border: 1px solid #eaeaea; box-shadow: 0 0 25px #EBEEF5;">
            <div style="display:felx;text-align: center;font-size:35px;font-size:35px;margin: 0px;padding:0px;height:30px"> {{item.title}}</div>            
